 ...
 *
 * 功能说明：
 * 1. 定义游戏核心参数（体力、金钱、角色数量等）
 * 2. 配置战斗系统参数（回合限制、伤害计算等）
 * 3. 设置游戏功能开关（拍卖行、论坛链接等）
 * 4. 定义文件路径和类库位置
 * 5. 配置游戏难度和成长系统
 *
 * 此文件包含游戏运行所需的所有核心配置参数，
 * 修改这些参数会影响游戏的整体平衡性和行为表现。
 * 注意：部分参数修改后需要清空游戏数据才能生效。
 */
...
const CRYPT_KEY = '$1$12345678$'; // 加密密钥？
...
const CLASS_JS_ITEMLIST = CLASS_DIR . "class.JS_item_list.php";
