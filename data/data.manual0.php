<div style="margin:15px">
		...
		<table cellspacing="5">
			<tbody>
				<tr>
					...
					<td style="text-align:center" class="bold">使用技能</td>
				</tr>
				<tr>
					<TD>1</TD>
					<TD><SELECT>
							<OPTION>必定</OPTION>
							<OPTION>自己的HP为50%以上时</OPTION>
							<OPTION>自己的HP为50%以下时</OPTION>
							<OPTION>同伴中有 HP为50%以下的人物时</OPTION>
							<OPTION>同伴的平均HP为 50%以上时</OPTION>
							<OPTION>同伴的平均HP为 50%以下时</OPTION>
							<OPTION>自己的SP为50%以上时</OPTION>
							<OPTION>自己的 SP为50%以下时</OPTION>
							<OPTION>以50%的概率</OPTION>
							<OPTION selected>初次行动时</OPTION>
							<OPTION>第二次行动时</OPTION>
							<OPTION>第三次行动时</OPTION>
							<OPTION>至少一次</OPTION>
							<OPTION>至少两次</OPTION>
							<OPTION>至少三次</OPTION>
						</SELECT> </TD>
				...
				<TR>
					...
					<TD><SELECT>
							...
							<OPTION>同伴里有 HP为50%以下的人物时</OPTION>
							<OPTION>同伴的平均HP为 50%以上时</OPTION>
							<OPTION>同伴的平均HP为 50%以下时</OPTION>
							<OPTION selected>自己的SP为50%以上时</OPTION>
							<OPTION>自己的 SP为50%以下时</OPTION>
							<OPTION>以50%的概率</OPTION>
							<OPTION>初次行动时</OPTION>
							<OPTION>第二次行动时</OPTION>
				...
				<TR>
					...
					<TD><SELECT>
							...
							<OPTION>自己的HP为50%以上时</OPTION>
							<OPTION>自己的HP为50%以下时</OPTION>
							<OPTION>同伴中有HP为50%以下的人物存在时</OPTION>
							<OPTION>同伴的平均HP为 50%以上时</OPTION>
							<OPTION>同伴的平均HP为50%以下时</OPTION>
							<OPTION>自己的 SP为50%以上时</OPTION>
							<OPTION>自己的 SP为50%以下时</OPTION>
							<OPTION>以50%的概率</OPTION>
							<OPTION>初次行动时</OPTION>
							<OPTION>第二次行动时</OPTION>
	...
	<table>
		<tbody>
			...
			<tr>
				...
				<td>
					<select>
						<OPTION selected>必定</OPTION>
						<OPTION>不保护</OPTION>
						<OPTION>自己的体力为 25% 以上的话</OPTION>
						<OPTION>自己的体力为 50% 以上的话</OPTION>
						<OPTION>自己的体力为 75% 以上的话</OPTION>
						<OPTION>以25%的概率</OPTION>
						<OPTION>以50%的概率</OPTION>
						<OPTION>以75%的概率</OPTION>
					</select>
				</td>
			</tr>
		</tbody>
	...
	<ul>
		<p>
			<LI><SPAN class=bold>对象</SPAN> - 技能能影响到的对象<BR><SPAN class=dmg>enemy</SPAN> - 敌人<BR><SPAN class=recover>friend</SPAN> - 同伴<BR><SPAN class=support>self</SPAN> - 对使用者自身而言<BR><SPAN class=charge>all</SPAN> - 敌人-同伴(全体)
			...
			<LI><SPAN class=bold>其他</SPAN><BR><SPAN class=spdmg>Magic</SPAN> - 使用魔法的技能。对威力和效果有影响int。<BR><SPAN class=charge>invalid</SPAN> - 对方的前卫(Front)未防守。<BR><SPAN class=support>BackAttack</SPAN> - 后列(Back)的人物优先成为使用对象。 </LI>
	</UL>
	...
	<p style="margin:15px">
		...
		人物处在后排时<span class="bold u">后排</span>时，HP消耗为平常的<span class="bold u">2倍</span>。
	</p>
	<!-- ---------------------------------------------------------------- -->
	<a name="ranking"></a>
	...
	<p><a href="http://www.123.com">Whitecatさま</a> - 武器级技能<br />
		<a href="http://www.123.com">Rドさま</a> - 人物
	</p>
</div>