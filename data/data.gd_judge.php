 ...
 * 
 * 功能说明：
 * 1. 展示游戏中所有战斗判定条件的详细说明
 * 2. 提供直观的条件分类和解释
 * 3. 帮助玩家理解战斗中的各种触发机制
 * 
 * 页面结构：
 * 1. 包含判定设置数据文件：加载判定基础数据
 * 2. 创建判定条件表格：使用双列布局展示条件和说明
 * 3. 使用交替行样式增强可读性
 * 
 * 判定条件分类：
 * 1. 必定执行类：
 ...
 * 2. 表格使用交替行样式(td6/td9类)增强可读性
 * 3. 条件描述使用简洁明了的语言
 * 
 * 注意事项：
 * 1. 需要确保DATA_JUDGE_SETUP常量正确定义
 * 2. 表格内容为硬编码，未来可扩展为动态加载
 * 3. 注释中保留了动态加载的示例代码（已注释）
 */
