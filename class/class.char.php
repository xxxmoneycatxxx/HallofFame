...
?>
		<table>
			<tr>
				<td valign="top" style="width:180px"><?php $this->ShowCharLink(); ?>
				</td>
				<td valign="top" style="padding-right:20px">
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td style="text-align:right">经验 : </td>
							<td><?php print $this->exp ?>/<?php print $this->CalcExpNeed() ?></td>
						</tr>
						<tr>
							<td style="text-align:right">生命 : </td>
							<td><?php print $this->maxhp ?><?php if ($P_MAXHP) print(" + {$P_MAXHP}"); ?></td>
						</tr>
						<tr>
							<td style="text-align:right">魔力 : </td>
							<td><?php print $this->maxsp ?><?php if ($P_MAXSP) print(" + {$P_MAXSP}"); ?></td>
						</tr>
						<tr>
							<td style="text-align:right">力量 : </td>
							<td><?php print $this->str ?><?php if ($this->P_STR) print(" + {$this->P_STR}"); ?></td>
						</tr>
						<tr>
							<td style="text-align:right">智慧 : </td>
							<td><?php print $this->int ?><?php if ($this->P_INT) print(" + {$this->P_INT}"); ?></td>
						</tr>
						<tr>
							<td style="text-align:right">敏捷 : </td>
							<td><?php print $this->dex ?><?php if ($this->P_DEX) print(" + {$this->P_DEX}"); ?></td>
						</tr>
						<tr>
							<td style="text-align:right">速度 : </td>
							<td><?php print $this->spd ?><?php if ($this->P_SPD) print(" + {$this->P_SPD}"); ?></td>
						</tr>
						<tr>
							<td style="text-align:right">幸运 : </td>
							<td><?php print $this->luk ?><?php if ($this->P_LUK) print(" + {$this->P_LUK}"); ?></td>
						</tr>
					</table>
				</td>
				<td valign="top">
	...
	?>
		...
		<div class="carpet_frame">
			<div class="carpet<?php print $flag % 2 ?>">
				<a href="?char=<?php print $this->Number ?>"><?php $this->ShowImage(); ?></a>
			</div>
