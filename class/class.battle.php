 ...
 * 
 * 全局函数说明：
 * 1. CountAlive() - 计算队伍存活角色数量
 * 2. CountAliveChars() - 计算初始角色存活数量
 * 3. CreateSummon() - 创建召唤单位
 * 4. MultiFactJudge() - 多条件复合判定
 */
